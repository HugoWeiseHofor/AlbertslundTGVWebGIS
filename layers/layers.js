...
var format_Erosionsdal = new ol.format.GeoJSON();
var features_Erosionsdal = format_Erosionsdal.readFeatures(json_Erosionsdal, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Erosionsdal = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Erosionsdal.addFeatures(features_Erosionsdal);
var lyr_Erosionsdal = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Erosionsdal, 
                style: style_Erosionsdal,
                popuplayertitle: 'Erosionsdal',
                interactive: true,
                title: '<img src="styles/legend/Erosionsdal.png" /> Erosionsdal'
            });
var format_Sbund = new ol.format.GeoJSON();
var features_Sbund = format_Sbund.readFeatures(json_Sbund, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sbund = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sbund.addFeatures(features_Sbund);
...
var format_Mose = new ol.format.GeoJSON();
var features_Mose = format_Mose.readFeatures(json_Mose, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Mose = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Mose.addFeatures(features_Mose);
...
var format_Albertslund = new ol.format.GeoJSON();
var features_Albertslund = format_Albertslund.readFeatures(json_Albertslund, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Albertslund = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Albertslund.addFeatures(features_Albertslund);
var lyr_Albertslund = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Albertslund, 
                style: style_Albertslund,
