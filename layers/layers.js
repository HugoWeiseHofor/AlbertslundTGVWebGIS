...
var features_Marinflade_6 = format_Marinflade_6.readFeatures(json_Marinflade, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Marinflade = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Marinflade.addFeatures(features_Marinflade_6);
...
var format_Erosionsdal_7 = new ol.format.GeoJSON();
var features_Erosionsdal_7 = format_Erosionsdal_7.readFeatures(json_Erosionsdal, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Erosionsdal = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Erosionsdal.addFeatures(features_Erosionsdal_7);
var lyr_Erosionsdal = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Erosionsdal, 
                style: style_Erosionsdal_7,
                popuplayertitle: 'Erosionsdal',
                interactive: true,
                title: '<img src="styles/legend/Erosionsdal.png" /> Erosionsdal'
            });
var format_Sbund_8 = new ol.format.GeoJSON();
var features_Sbund_8 = format_Sbund_8.readFeatures(json_Sbund, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Sbund = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Sbund.addFeatures(features_Sbund_8);
var lyr_Sbund = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Sbund, 
                style: style_Sbund_8,
                popuplayertitle: 'Søbund',
                interactive: true,
                title: '<img src="styles/legend/Sbund.png" /> Søbund'
            });
var format_Mose_9 = new ol.format.GeoJSON();
var features_Mose_9 = format_Mose_9.readFeatures(json_Mose, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Mose = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Mose.addFeatures(features_Mose_9);
var lyr_Mose = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Mose, 
                style: style_Mose_9,
                popuplayertitle: 'Mose',
                interactive: true,
                title: '<img src="styles/legend/Mose.png" /> Mose'
            });
...
var format_RisikoforstningsskaderGEO_13 = new ol.format.GeoJSON();
var features_RisikoforstningsskaderGEO_13 = format_RisikoforstningsskaderGEO_13.readFeatures(json_RisikoforstningsskaderGEO, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_RisikoforstningsskaderGEO = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_RisikoforstningsskaderGEO.addFeatures(features_RisikoforstningsskaderGEO_13);
var lyr_RisikoforstningsskaderGEO = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_RisikoforstningsskaderGEO, 
                style: style_RisikoforstningsskaderGEO_13,
                popuplayertitle: 'Risiko for sætningsskader (GEO)',
                interactive: true,
    title: 'Risiko for sætningsskader (GEO)<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_13_0.png" /> 0-0,01<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_13_1.png" /> 0,01-0,02<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_13_2.png" /> 0,02-0,05<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_13_3.png" /> 0,05-0,1<br />\
    <img src="styles/legend/RisikoforstningsskaderGEO_13_4.png" /> >0,1<br />' });
...
var format_EngeogMoser18701899_29 = new ol.format.GeoJSON();
var features_EngeogMoser18701899_29 = format_EngeogMoser18701899_29.readFeatures(json_EngeogMoser18701899, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_EngeogMoser18701899 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EngeogMoser18701899.addFeatures(features_EngeogMoser18701899_29);
var lyr_EngeogMoser18701899 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EngeogMoser18701899, 
                style: style_EngeogMoser18701899_29,
...
var format_Ingenkloakering_31 = new ol.format.GeoJSON();
var features_Ingenkloakering_31 = format_Ingenkloakering_31.readFeatures(json_Ingenkloakering, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Ingenkloakering = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ingenkloakering.addFeatures(features_Ingenkloakering_31);
var lyr_Ingenkloakering = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Ingenkloakering, 
                style: style_Ingenkloakering_31,
                popuplayertitle: 'Ingen kloakering',
                interactive: true,
                title: '<img src="styles/legend/Ingenkloakering.png" /> Ingen kloakering'
            });
var format_Albertslund_32 = new ol.format.GeoJSON();
var features_Albertslund_32 = format_Albertslund_32.readFeatures(json_Albertslund, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Albertslund = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Albertslund.addFeatures(features_Albertslund_32);
var lyr_Albertslund = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Albertslund, 
                style: style_Albertslund_32,
                popuplayertitle: 'Albertslund',
                interactive: true,
                title: '<img src="styles/legend/Albertslund.png" /> Albertslund'
            });
// Ikke Kort
...
lyr_ESRIGraylight_0.setVisible(true);lyr_OpenStreetMap_1.setVisible(true);lyr_PlanfladeSpildevand.setVisible(false);lyr_ProjektfladeSpildevand.setVisible(false);lyr_ProjektfladeVand.setVisible(false);lyr_Antropogentlandskab.setVisible(false);lyr_Marinflade.setVisible(false);lyr_Erosionsdal.setVisible(false);lyr_Sbund.setVisible(false);lyr_Mose.setVisible(false);lyr_Bundmorneflade.setVisible(false);lyr_TerrnnrtgrundvandsommermiddelmunderterrnHIP.setVisible(false);lyr_TerrnnrtgrundvandvintermiddelmunderterrnHIP.setVisible(false);lyr_RisikoforstningsskaderGEO.setVisible(false);lyr_RisikoforoversvmmelseKystdirektoratet.setVisible(false);lyr_Boringerdybdeim.setVisible(false);lyr_IndledendeskadesberegningerGennemsnitligskadesomkostningerfrtiltagDKKr_16.setVisible(true);lyr_Vandlb100mbuffer.setVisible(false);lyr_Vandlb20mbuffer.setVisible(false);lyr_Vandlb10mbuffer.setVisible(false);lyr_Vandlb2mbuffer.setVisible(false);lyr_Vandlb.setVisible(false);lyr_Ser100mbuffer.setVisible(false);lyr_Ser20mbuffer.setVisible(false);lyr_Ser10mbuffer.setVisible(false);lyr_Ser2mbuffer.setVisible(false);lyr_Ser.setVisible(false);lyr_Jordforureningvidenniveau2V2.setVisible(false);lyr_Jordforureningvidenniveau1V1.setVisible(false);lyr_EngeogMoser18701899.setVisible(false);lyr_Frededeomrder.setVisible(false);lyr_Ingenkloakering.setVisible(true);lyr_Albertslund.setVisible(true);
...
lyr_Sbund.set('fieldAliases', {'fid': 'fid', 'tsym': 'tsym', 'version': 'version', 'landscape': 'landscape', 'landskab': 'landskab', 'shape_leng': 'shape_leng', 'ruleid': 'ruleid', 'overfoerse': 'overfoerse', 'st_area_sh': 'st_area_sh', 'st_perimet': 'st_perimet', });
lyr_Mose.set('fieldAliases', {'fid': 'fid', 'tsym': 'tsym', 'version': 'version', 'landscape': 'landscape', 'landskab': 'landskab', 'shape_leng': 'shape_leng', 'ruleid': 'ruleid', 'overfoerse': 'overfoerse', 'st_area_sh': 'st_area_sh', 'st_perimet': 'st_perimet', });
...
lyr_Albertslund.set('fieldAliases', {'fid': 'fid', 'navn': 'navn', });
...
lyr_Sbund.set('fieldImages', {'fid': 'TextEdit', 'tsym': 'TextEdit', 'version': 'TextEdit', 'landscape': 'TextEdit', 'landskab': 'TextEdit', 'shape_leng': 'TextEdit', 'ruleid': 'TextEdit', 'overfoerse': 'DateTime', 'st_area_sh': 'TextEdit', 'st_perimet': 'TextEdit', });
lyr_Mose.set('fieldImages', {'fid': 'TextEdit', 'tsym': 'Range', 'version': 'TextEdit', 'landscape': 'TextEdit', 'landskab': 'TextEdit', 'shape_leng': 'TextEdit', 'ruleid': 'TextEdit', 'overfoerse': 'DateTime', 'st_area_sh': 'TextEdit', 'st_perimet': 'TextEdit', });
...
lyr_Albertslund.set('fieldImages', {'fid': 'TextEdit', 'navn': 'TextEdit', });
...
lyr_Sbund.set('fieldLabels', {'fid': 'no label', 'tsym': 'no label', 'version': 'no label', 'landscape': 'no label', 'landskab': 'no label', 'shape_leng': 'no label', 'ruleid': 'no label', 'overfoerse': 'no label', 'st_area_sh': 'no label', 'st_perimet': 'no label', });
lyr_Mose.set('fieldLabels', {'fid': 'no label', 'tsym': 'no label', 'version': 'no label', 'landscape': 'no label', 'landskab': 'no label', 'shape_leng': 'no label', 'ruleid': 'no label', 'overfoerse': 'no label', 'st_area_sh': 'no label', 'st_perimet': 'no label', });
...
lyr_Albertslund.set('fieldLabels', {'fid': 'no label', 'navn': 'no label', });
lyr_Albertslund.on('precompose', function(evt) {
