...
lyr_Albertslund.setZIndex(9999);
lyr_Albertslund.setVisible(true);
lyr_Albertslund.set('title', '');
map.addLayer(lyr_Albertslund);

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([1366263.480557, 7482968.287854, 1390933.409703, 7504915.660136], map.getSize());

//full zooms only
map.getView().fit(
    [1366263.480557, 7482968.287854, 1390933.409703, 7504915.660136],
